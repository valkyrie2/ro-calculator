  ...
  updates: { v: string; date: string; logs: string[]; }[] = [
    {
      ...
      logs: [
        ...
        'เพิ่ม Aladdin Shoes-LT [1] (470460) และ Ragnarok Stars 2026 Cape [1] (480908) พร้อม Option ตามขั้นอัพเกรดและ Grade D-A ครบ',
        'เพิ่มหน้ากาก Thanatos 6 ชิ้น (436000-436005): Maeror = MATK + 3%, Despero = ATK + 3%, Odium = MHP + 5% (ส่วน Damage ต่อ Player เป็น PvP ไม่ได้คำนวณ)',
        'เพิ่มไข่ Q-Pet 4 ฟอง: Copo Egg (9145, ATK/MATK + 2%), Grey Icewind Egg (9146, ATK + 3%, POW + 2), Icewind Egg (9147, MATK + 3%, SPL + 2), Celine Kimi Egg (9195, Damage ทางกายภาพ/เวทมนตร์ต่อศัตรูทุกธาตุ + 5%, ลดร่ายแปรผัน 3%, ลด Global Cooldown 2%) — ใช้ค่าระดับสนิทสนม',
        'เพิ่มการ์ด Assassin Cross Card (4359), MasterSmith Card (4361), Sniper Card (4367) ทำให้เซ็ตการ์ดของ Thought Ring / Thought Ring-LT ครบทั้ง 6 ใบ',
        'ไม่ได้ใส่: Costume ที่ไม่มีผลต่อค่าสถานะ, ของใช้/วัตถุดิบ, Kiel Effect (300566) และ Enchant 315344-315382 เพราะ Divine Pride ไม่มีข้อมูลผล',
        'Enchant EP20 The Immortal (Glacier / Dim Glacier) มีครบอยู่แล้วในระบบ',
