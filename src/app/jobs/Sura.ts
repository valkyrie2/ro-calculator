  ...
  private readonly activeSkillList3rd: ActiveSkillModel[] = [
    {
      ...
      dropdown: [
        ...
        { label: 'Lv 1', value: 1, isUse: true, bonus: { hpPercent: 1, spPercent: 1, cri: 20 } },
        { label: 'Lv 2', value: 2, isUse: true, bonus: { hpPercent: 2, spPercent: 2, cri: 20 } },
        { label: 'Lv 3', value: 3, isUse: true, bonus: { hpPercent: 3, spPercent: 3, cri: 20 } },
        { label: 'Lv 4', value: 4, isUse: true, bonus: { hpPercent: 4, spPercent: 4, cri: 20 } },
        { label: 'Lv 5', value: 5, isUse: true, bonus: { hpPercent: 5, spPercent: 5, cri: 20 } },
        { label: 'Lv 6', value: 6, isUse: true, bonus: { hpPercent: 6, spPercent: 6, cri: 20 } },
        { label: 'Lv 7', value: 7, isUse: true, bonus: { hpPercent: 7, spPercent: 7, cri: 20 } },
        { label: 'Lv 8', value: 8, isUse: true, bonus: { hpPercent: 8, spPercent: 8, cri: 20 } },
        { label: 'Lv 9', value: 9, isUse: true, bonus: { hpPercent: 9, spPercent: 9, cri: 20 } },
        { label: 'Lv 10', value: 10, isUse: true, bonus: { hpPercent: 10, spPercent: 10, cri: 20 } },
      ],
    },
    {
      label: 'GT - Opposite',
